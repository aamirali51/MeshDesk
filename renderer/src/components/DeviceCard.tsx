...
interface DeviceCardProps {
  ...
  onShareCode: (device: Device) => void
}
...
export function DeviceCard({
  ...
  const items: ContextMenuItem[] = [
    ...
    {
      label: 'Share via One-Time Code',
      icon: <Link2 className='h-3.5 w-3.5' />,
      onClick: () => onShareCode(device)
    },
    { separator: true },
    {
      label: 'Remove Device',
  ...
  return (
    <Card
      className={cn(
        'border-border/60 transition-all hover:border-primary/40',
        ...
        <div className='flex items-center justify-between border-t border-border/40 pt-3'>
          <div className='flex items-center gap-1.5'>
            ...
            <Button
              ...
              aria-label='Share via One-Time Code'
            >
