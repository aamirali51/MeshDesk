...
export function QRCodeModal({ isOpen, onClose }: QRCodeModalProps) {
  ...
  // Generate QR from the RAW pairing code so any MeshDesk scanner
  ...
  return (
    <Modal
      ...
      description='Scan with another MeshDesk device or share the short code'
      className='max-w-lg'
    >
      ...
      <div className='flex flex-col gap-y-6'>
        ...
        <div className='flex flex-col items-center gap-y-4 rounded-2xl border border-slate-200 bg-slate-50 p-5 shadow-inner dark:border-border/60 dark:bg-black/40'>
          {qrDataUrl ? (
            <div className='rounded-lg border border-slate-200 bg-white p-2 shadow-lg dark:border-white/10 dark:bg-slate-900'>
