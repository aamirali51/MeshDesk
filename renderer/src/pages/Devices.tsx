  ...
  return (
    <div className='space-y-6 pb-12'>
      ...
      <div className='flex flex-col justify-between gap-4 md:flex-row md:items-center'>
        <div>
          <h2 className='text-xl font-black text-foreground'>Devices</h2>
          <p className='text-xs text-muted-foreground'>
            Manage paired workstations, trusted clients, and active P2P endpoints.
          </p>
        </div>
      ...
      {filteredDevices.length === 0 ? (
        <div className='rounded-2xl border border-dashed border-border/80 p-12 text-center space-y-3'>
          ...
          <p className='mx-auto max-w-sm text-xs text-muted-foreground'>
            {devices.length === 0
              ? 'Pair another device with a code or QR scan to start sharing files directly.'
