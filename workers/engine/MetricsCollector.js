...
// and CPU/RAM from bare-os. Unknown values stay null so the UI can render "—".

// bare-os is only available inside the Bare worker runtime; in host-node tests
// it fails to load, so it is required defensively and all system sampling is
// skipped when absent.
let os = null
try {
  os = require('bare-os')
...
class MetricsCollector {
  ...
  // CPU and RAM from bare-os. CPU is system-wide: the idle/total delta over
